...
namespace CrispyWaffle.Utils.GoodPractices
{
    ...
    public class FtpClientException : Exception
    {
        ...
        public FtpClientException(string path, string action, FtpStatusCode responseCode)
            : base(string.Format(CultureInfo.CurrentCulture, "Unable to {1} the path/file {0} in the FtpClient host. Status code: {2}", path, action, responseCode))
        { }
        ...
        public FtpClientException(string path, string action, Exception innerException)
            : base(string.Format(CultureInfo.CurrentCulture, "Unable to {1} the path/file {0} in the FtpClient host. Status code: {2}", path, action, 0), innerException)
        { }
