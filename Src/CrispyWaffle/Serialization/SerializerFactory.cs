...
public static class SerializerFactory
{
        ...
        where T : class
    {
        ...
        var attribute =
            Attribute.GetCustomAttribute(type, typeof(SerializerAttribute)) as SerializerAttribute;
    ...
    /// <returns>A <see cref="SerializerConverter{T}"/> for the specified object.</returns>
    [Pure]
    public static SerializerConverter<T> GetCustomSerializer<T>(this T obj, SerializerFormat format)
