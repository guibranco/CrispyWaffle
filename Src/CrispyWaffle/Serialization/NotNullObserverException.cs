namespace CrispyWaffle.Serialization
{
    ...
    public class NotNullObserverException : Exception
    {
        ...
        public NotNullObserverException(JsonToken type, object value, string path)
            : base($"Not null observer found a not null value in path {path} of type {type}: {value}")
        { }
        ...
        public NotNullObserverException(Type parentType, Exception innerException)
            : base($"Unable to serialize type {parentType.FullName}. Constraints: Not null observer", innerException)
        { }
        ...
        protected NotNullObserverException(SerializationInfo info, StreamingContext context) : base(info, context)
        { }
    }
}
