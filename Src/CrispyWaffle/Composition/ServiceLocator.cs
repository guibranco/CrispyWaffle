...
public static class ServiceLocator
{
    ...
    /// </summary>
    private static readonly Dictionary<Type, IDependencyResolver> _dependenciesResolvers = new();
...
#pragma warning restore S1144 // Unused private types or members should be removed
    ...
    public static void RegisterBootstrapper<TBootstrapper>()
        where TBootstrapper : class, IBootstrapper, new() => new TBootstrapper().RegisterServices();
    ...
    public static void Register<TImplementation>() => Register<TImplementation>(Lifetime.Transient);
